...
PICS = (environ.get('PICS', 'https://telegra.ph/file/6a0726f79acd8300e9a04.jpg')).split()
...
SHORTLINK_API = environ.get('SHORTLINK_API', '9031de913dc3f597883333f595adc0495535a5ef')
IS_SHORTLINK = bool(environ.get('IS_SHORTLINK', "True"))
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/mallu_movie_search')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+fAHy3KCjmtthOWRl')
